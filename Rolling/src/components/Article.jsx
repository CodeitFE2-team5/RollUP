      ...
      <div className="mt-[56px] mb-[56px]">
        <div className="flex justify-between gap-[30px] mx-auto mb-[30px] py-[60px] pl-[60px] w-[1070px] h-[324px] rounded-[16px] bg-slate-50">
          <div className="flex-col justify-start items-start gap-4 inline-flex ">
            <div className="px-3 py-1.5 bg-purple-700 rounded-3xl flex-col justify-center items-center gap-2.5 flex">
        ...
        <div className="flex items-center py-[60px] mx-auto w-[1070px] h-[324px] rounded-[16px] bg-slate-50">
          <img src={img02} />
