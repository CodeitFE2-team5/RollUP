  ...
  return (
    <div className="overflow-hidden rounded-2xl">
      <div
        ...
        className={`relative w-[156px] h-[156px]  bg-no-repeat rounded-2xl transition-transform duration-500 hover:scale-125 cursor-pointer sm:w-[21.9vw] sm:h-[21.9vw] md:w-[168px] md:h-[168px] `}
      >
